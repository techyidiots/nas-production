$(document).ready(function(e){
    ...
    $("li[data-label=English]").find("a").on("click", function(e){
        e.preventDefault();
    ...
    $("li[data-label=Arabic]").find("a").on("click", function(e){
       e.preventDefault();
    ...
    if(query_params && query_params["_lang"]==="en")
        $("li[data-label=English]").hide();
    else
        $("li[data-label=Arabic]").hide()
